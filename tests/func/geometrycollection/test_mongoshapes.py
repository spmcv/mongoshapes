...
from mongoengine import Document, QuerySet, InvalidQueryError
...
def test_save(document: DocType, geometry: GeoShape):
    """
...
@pytest.mark.xfail(
    ...
    reason="query does not work on GeometryCollection"
)
